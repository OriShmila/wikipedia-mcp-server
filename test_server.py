#!/usr/bin/env python3
"""
Comprehensive test suite for the Wikipedia MCP server.
Tests actual tool calls with real Wikipedia API requests.
"""
...
async def run_tool_test(
    ...
    try:
        ...
        from wikipedia_mcp_server.server import TOOL_FUNCTIONS
        ...
        if test_case.get("should_succeed", True):
            ...
            with open("wikipedia_mcp_server/tools.json", "r") as f:
...
async def test_server_components():
    ...
    try:
        ...
        from wikipedia_mcp_server.server import load_tool_schemas, TOOL_FUNCTIONS
